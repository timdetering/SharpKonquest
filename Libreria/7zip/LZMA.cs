...
namespace System.IO.Compression
{
    public static class LZMA
    {
        ...
        public static byte[] Compress(byte[] inArray)
        {
            MemoryStream entrada = new MemoryStream(inArray);
            MemoryStream salida = new MemoryStream();

            Compress(entrada, salida);

            byte[] res = salida.ToArray();
       ...
       public static void Decompress(string compressedFile, string outFile)
        {
        ...
        public static byte[] Decompress(byte[] compressedArray)
        {
            MemoryStream entrada = new MemoryStream(compressedArray);
            MemoryStream salida = new MemoryStream();

            Decompress(entrada, salida);
